...
encrypted_account_id <- getSummonerByName('jakeateworld', key ="RGAPI-fbccf05d-d936-45b3-a744-cc2c268b887b")$accountId
encrypted_account_id

matchID_example <- getGameBySummonerID(encrypted_account_id, key = "RGAPI-fbccf05d-d936-45b3-a744-cc2c268b887b")$matches[[1]]$gameId
matchID_example

match_list <- getGameByMatchID(matchID_example, key = "RGAPI-a9e46632-184b-47c7-a6bf-222051b0d857")


df <- item_analysis(champion = "Zed", name = "JAKEATEWORLD", key = "RGAPI-fbccf05d-d936-45b3-a744-cc2c268b887b")
